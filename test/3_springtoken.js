...
contract('SpringToken', function(accounts) {
    ...
    return SpringToken.deployed()
      ...
      .then(function(balance) {
        ...
        assert.equal(
          new_balance,
          old_balance + amount,
          '10000 tokens were not minted or not assigned to owner'
        );
      });
  });
    ...
    return SpringToken.deployed()
      ...
      .then(function(allowance) {
        ...
        assert.equal(
          ...
          allowance_before_transfer - amount_transferred,
      ...
      .then(function(balance) {
        ...
        assert.equal(
          account_one_ending_balance,
          account_one_starting_balance - amount_transferred,
          "Amount wasn't correctly taken from the sender"
        );
        assert.equal(
          account_two_ending_balance,
          account_two_starting_balance + amount_transferred,
          "Amount wasn't correctly sent to the receiver"
        );
      });
  });
  ...
  it('should increase approval 1 token correctly', function() {
    ...
    return SpringToken.deployed()
      ...
      .then(function(balance) {
        ...
        return token.increaseApproval(accounts[2], amount, {
          from: accounts[1]
        });
      })
      .then(function(allowance) {
      ...
      .then(function(balance) {
        ...
        assert.equal(
          approval_ending_balance,
          approval_starting_balance + amount,
          "Amount wasn't correctly approved"
        );
      });
  });
  ...
  it('should decrease approval 1 token correctly', function() {
    ...
    return SpringToken.deployed()
      ...
      .then(function(balance) {
        approval_starting_balance = balance.toNumber();
        return token.decreaseApproval(accounts[2], amount, {
          from: accounts[1]
        });
      })
      .then(function(allowance) {
  ...
  it('should be able to change paused status', function() {
    return SpringToken.deployed()
      ...
      .then(function(paused) {
        assert.isTrue(
          paused.valueOf(),
          'should be able to change paused status'
        );
      });
  });
